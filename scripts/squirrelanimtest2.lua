...
--Add the animation
qm("Loading Model 1")
Squirrel:addModel(model.load("objects/animations/swt.obj", 0.1, color.new(0, 0, 0)))
qm("Loading Model 2")
Squirrel:addModel(model.load("objects/animations/swn.obj", 0.1, color.new(0, 0, 0)))
qm("Loading Model 3")
Squirrel:addModel(model.load("objects/animations/swm.obj", 0.1, color.new(0, 0, 0)))
qm("Loading Model 4")
Squirrel:addModel(model.load("objects/animations/swr.obj", 0.1, color.new(0, 0, 0)))
qm("Loading Model 5")
Squirrel:addModel(model.load("objects/animations/swl.obj", 0.1, color.new(0, 0, 0)))
qm("Loading Model 6")
Squirrel:addModel(model.load("objects/animations/swj.obj", 0.1, color.new(0, 0, 0)))
